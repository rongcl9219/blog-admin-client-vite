    ...
    <el-dropdown class="avatar-container" trigger="click">
        <template #default>
            <div class="avatar-wrapper">
                <el-avatar style="margin-right: 5px" shape="square" :size="40">
        ...
        <template #dropdown>
            <el-dropdown-menu class="user-dropdown">
                <el-dropdown-item @click="userInfoVisible = true">个人信息</el-dropdown-item>
                <el-dropdown-item @click="updatePasswordVisible = true">修改密码</el-dropdown-item>
