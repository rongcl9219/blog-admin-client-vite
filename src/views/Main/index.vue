        ...
        <el-card class="box-card">
            <template #header>
                <div class="card-header">
                    <p style="color: rgb(107, 132, 148)">
                        <span class="header-title" style="margin-right: 20px">欢迎光临</span
                        >【火星的青青草原-管理后台】
                    </p>
                </div>
            </template>
            <el-card class="box-card" style="margin-bottom: 20px">
                ...
                <div>
                    ...
                    <ul>
                        <li class="list-item about" v-for="(item, index) in githubArr" :key="index">
                            <el-link
                                :underline="false"
                                type="primary"
                                target="_blank"
                            ...
                            >
                                <span class="list-item-title"
                                    ><svg-icon icon-class="circle" />{{ item.name }}：<span>{{
                                        item.link
                                    }}</span></span
                                >
                            </el-link>
