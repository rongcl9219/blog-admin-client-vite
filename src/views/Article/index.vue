<template>
  <div class="article-page">
        ...
        >
          <div class="article-item-con">
            ...
            <div class="article-item-right">
              ...
              <div
                class="article-cover"
                @click="goView(article.articleId)"
              >
                <img
    ...
    <el-drawer
      v-model="articleDialog.dialogVisible"
      :size="600"
    ...
    >
        ...
        <el-scrollbar>
          ...
          >
            ...
            >
              ...
              <el-button
                type="primary"
                @click="articleDialog.uploadImgVisible = true"
              >
                上传封面
              </el-button>
            </el-form-item>
      ...
      <template #footer>
        <div style="flex: auto">
          <el-button @click="articleDialog.dialogVisible = false">
            取消
          </el-button>
          <el-button
            type="primary"
    ...
    <UploadImage
      v-model:img-list="articleForm.articleCoverInfo"
      v-model:upload-img-visible="articleDialog.uploadImgVisible"
      :img-width="100"
      :img-height="100"
    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button @click="editContentModel.mdEditorVisible = false">
            返回
          </el-button>
          <el-button
            type="primary"
...
import type { ArticleInfo, ArticleInfoForm } from '@/api/article/types'
...
const articleForm = reactive<ArticleInfoForm>({
  articleId: '',
  articleTitle: '',
  articleSubtitle: '',
  articleKeyword: '',
